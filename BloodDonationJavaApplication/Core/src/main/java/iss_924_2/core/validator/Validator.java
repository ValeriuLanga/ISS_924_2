...
import iss_924_2.core.exceptions.InvalidPhoneNumber;
...
public final class Validator {
    ...
    public static void validatePhoneNumber(String phoneNumber) {
        ...
        if(phoneNumber.length() != 10)
            throw new InvalidPhoneNumber("Phone number must have 10 digits!");
        if(phoneNumber.charAt(0) == '0')
            throw new InvalidPhoneNumber("Phone number must start with '0'!");
    }
}
